...
class MM extends Component {
    ...
    onButtonClickHandler = (event) => {
        ...
        // switch(this.state.screen.active){
        //     case 'project':
        //         this.setState({
        //             projectButton: {
        //                 ...this.state.projectButton,
        ...
        return (
            ...
            {/*src={project_icon_green} style={imgSizes} alt="green project icon"*/}
                <div style={{"width": '100%', 'height' : '100%'}}>
                    <Button styles={this.state.projectButton} hover={this.hoverButton} clicked={this.onButtonClickHandler} reset={this.buttonReset} ></Button>
                    <Button styles={this.state.linkedinButton} hover={this.hoverButton} clicked={this.onButtonClickHandler} reset={this.buttonReset}/>
                    <Button styles={this.state.homeButton} hover={this.hoverButton} clicked={this.onButtonClickHandler} />
                    <Button styles={this.state.gitButton} hover={this.hoverButton} clicked={this.onButtonClickHandler} />
                    <Button styles={this.state.codepenButton} hover={this.hoverButton} clicked={this.onButtonClickHandler} />
                    <Button styles={this.state.contactButton} hover={this.hoverButton} clicked={this.onButtonClickHandler} />
                    <Button styles={this.state.cvButton} hover={this.hoverButton} clicked={this.onButtonClickHandler} />
                </div>
